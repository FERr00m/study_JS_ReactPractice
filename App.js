    ...
    return (
      <div className="features-slider">
        <div className="features-slider_items">
          <SliderItem style={{backgroundImage: 'url(./images/1.svg)'}} text="Первое целевое преимущество"/>
          <SliderItem style={{backgroundImage: 'url(./images/2.svg)'}} text="Второе целевое преимущество"/>
          <SliderItem style={{backgroundImage: 'url(./images/3.svg)'}} text="Третье целевое преимущество"/>
          <SliderItem style={{backgroundImage: 'url(./images/4.svg)'}} text="Четвертое целевое преимущество"/>
				</div>
